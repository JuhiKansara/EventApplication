...
class _HomeState extends State<Home> {
    ...
    eventStream!.listen((event) async {
      ...
      for (var doc in event.docs) {
        ...
        if (eventDateStr.isNotEmpty) {
          ...
          DateTime? eventonlydate;
          // try {
          //   eventDate = DateFormat('MMM dd').parse(eventDateStr);
          //   // Append current year, assuming events are for current year
          //   eventDate = DateTime(today.year, eventDate.month, eventDate.day);
          // } catch (_) {
          //   // Fallback to default DateTime parse if it works
  ...
  Future<void> cleanUpExpiredEvents() async {
    ...
    for (var doc in querySnapshot.docs) {
      ...
      // Support both string and Timestamp formats
